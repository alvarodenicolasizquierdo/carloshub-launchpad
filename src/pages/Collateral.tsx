...
const RESOURCES: Resource[] = [
  ...
  { title: "The Trust Shift — Board Strategy Deck", format: "PDF", icon: Presentation, audience: "Board / Executive", status: "available", isNew: true, description: "From Commodity Testing to the Compliance Operating System — 84-source strategic analysis of the global TIC industry covering market evolution, regulatory triggers, competitive landscape, and the shift from labs to digital compliance platforms. Feb 2026.", downloadUrl: "/collateral/TIC-Strategy-Board-Deck_-_THE_TRUST_SHIFT.pdf" },
];
